 ...
 */
export async function getExtensionRepos(page = 1) {
...
*/
export async function fetchExtensionManifest(contents_url, branch, stars) {
  try {
...
*/
export async function getThemeRepos(page = 1) {
